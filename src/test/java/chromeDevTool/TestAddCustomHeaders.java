...
public class TestAddCustomHeaders {
	...
	public static void main(String[] args) {
		...
		headers.put("CustomHeadersName", "CustomHeadersValue");
		headers.put("Mahima", "Test Engineer");
		Headers head=new Headers(headers);
		devtool.send(Network.setExtraHTTPHeaders( head));
